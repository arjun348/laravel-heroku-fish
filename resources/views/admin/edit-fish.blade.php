                    ...
                    <div class="main-content">
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- form-add-product -->
                                <form method="POST" action="{{ route('admin.fishes.update', ['fish' => $fish->id]) }}" class="form-add-product" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="wg-box mb-30">
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" name="name" placeholder="Enter name" name="name"
                                                tabindex="0" value="{{ $fish->name }}" aria-required="true" >
                                        ...
                                        <div class="cols-lg gap22">
                                            <fieldset class="price">
                                                ...
                                                <input class="" type="number" placeholder="Price" name="price"
                                                    tabindex="0" value="{{ $fish->price }}" aria-required="true" >
                                            </fieldset>
                                        </div>
                                        ...
                                        <fieldset class="description">
                                            ...
                                            <textarea class="mb-10" name="description"
                                                ...
                                                aria-required="true">{{ $fish->description }}</textarea>
                                    ...
                                    <div class="cols gap10">
                                        <button class="tf-button w380" type="submit">Update fish</button>
                                    </div>
                                </form>
                                <!-- /form-add-product -->
                            </div>
